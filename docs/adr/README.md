...
| [0016](0016-self-hosted-web-search-openserp.md) | Web search for Open WebUI: self-hosted OpenSERP as its own opt-in release behind an engine-pinning, path-restricting sidecar; SearXNG as the fallback chosen by a bake-off; first NetworkPolicy in the repo (Proposed) |
